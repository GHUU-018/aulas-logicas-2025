...
if(salario < 2000){console.log(`Seu salario é de ${(salario*12/100) + salario}`)
}else if (salario >= 2000 && salario <= 4000){console.log(`seu salario é de ${(salario*10/100) + salario}`);
}else{console.log(` seu salario e de ${(salario*8/100) + salario}`);
}
